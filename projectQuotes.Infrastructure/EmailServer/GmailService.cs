    ...
    public async Task SendEmailAsync(EmailRequest emailRequest)
    {
        try
        {
            MailjetRequest request = new MailjetRequest
            {
             ...
             .Property(Send.FromName, "QuoteCraft")
...
<body>
    <div class=""container"">
        ...
        <div class=""content"">
            ...
            <p>Thank you for joining QuoteCraft. We're excited to welcome you to our community!</p>
            <p>To start planning your travels, please confirm your email address:</p>
            <div class=""button-container button"">
                <a href=""{{Link}}"" class=""button"">Confirm email address</a>
            </div>
            <p class=""notice"">If you didn't create an account on QuoteCraft, please ignore this message.</p>
        </div>
        <div class=""footer"">
            <p>&copy; 2025 QuoteCraft. All rights reserved.</p>
        </div>
    </div>
</body>
</html>";
